...
BLOG_AUTHOR = {"name": "FZ", "mastodon": "https://mastodon.uno/fatualux"}  # (translatable)
BLOG_TITLE = "V-CaOS"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.v-caos.iceiy.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.ils.org"
BLOG_EMAIL = "v-caos@gmail.com"
BLOG_DESCRIPTION = "Open Source in Valcamonica"  # (translatable)
